...
var doc = document,
	...
	Chart.Axis = function (chart, options) {
		 ...
		 * @param {Object} options
		 */
		PlotLineOrBand = function (options) {
			var plotLine = this;
			if (options) {
		...
		destroy: function() {
			...
			erase(plotLinesAndBands, obj);
                ...
                /**
                 * @member Highcharts.Axis
		 * Get the minimum and maximum for the series of each axis 
		 */
		Axis.getSeriesExtremes = function () {
			var posStack = [],
				negStack = [],
				run;
		 ...
		 */
		Axis.getPlotLinePath = function(value, lineWidth, old) {
		 ...
		 * 
		 */
		Axis.setExtremes = function (newMin, newMax, redraw, animation) {
		 ...
		 * @param options {Object} The plotBand or plotLine configuration object
                 * @method
		 */
		Axis.addPlotBandOrLine = function addPlotBandOrLine(options) {
		 ...
		 * @param {Object} id
                 * @method
		 */
		Axis.removePlotBandOrLine = function (id) {
		 ...
		 * @param {Boolean} doRedraw
                 * @method
		 */
		Axis.setCategories = function (newCategories, doRedraw) {
				// set the categories
...
//some default value settings and other functions
{
/**
 * @ignore
 ...
 */
Element.attr = function (elem, prop, value) {
	var key,
...
defaultOptions = {
	...
	/*
	 * @cfg {Object} Options regarding the chart area and plot area as well as general chart options.
	 */
	chart: {
		//animation: true,
		//alignTicks: false,
 ...
 * @singleton
 */
Highcharts = new function (){
	// javadoc utility to show singleton classes.
};


/**
 * Sets the options globally for all charts created after this has been called. These options are merged with the default options and the result is returned.
 * @param {Object} options The chart configuration object.
 * @return options A merge between the default options and the user set options.
 * @method
 */
 ...
 * @return {Highcharts.Chart} A reference to the created Chart object.
 * @method
 */
Highcharts.Chart = function (options, callback) {
	...
	/* 
	 * Create a new axis object (ignored)
	 * @param {Object} chart
	 * @param {Object} options
	 */
	var Axis = function (chart, options) {
		...
		/*
		 * The object wrapper for plot lines and plot bands (ignored)
		 * @param {Object} options
		 */
 ...
 * @ignore
		...
		function move(finalX, finalY) {
			...
			currentX = finalX;//tooltipIsHidden ? finalX : (2 * currentX + finalX) / 3;
			currentY = finalY;//tooltipIsHidden ? finalY : (currentY + finalY) / 2;
 ...
 * See http://php.net/manual/en/function.number-format.php for a full explanation of the parameters.
...
/**
 * @member Highcharts
 * Formats a JavaScript date timestamp (milliseconds since Jan 1st 1970) into a human readable date string. The format is a subset of the formats for
 * <a href="http://php.net/manual/en/function.strftime.php">PHP's strftime function</a>.
 * <br>Currently these formats are supported:
 * <pre><br>	%a: Short weekday, like 'Mon'.
 * <br>	%A: Long weekday, like 'Monday'.
 * <br>	%d: Two digit day of the month, 01 to 31.
 * <br>	%e: Day of the month, 1 through 31.
 * <br>	%b: Short month, like 'Jan'.
 * <br>	%B: Long month, like 'January'.
 * <br>	%m: Two digit month number, 01 through 12.
 * <br>	%y: Two digits year, like 09 for 2009.
 * <br>	%Y: Four digits year, like 2009.
 * <br>	%H: Two digits hours in 24h format, 00 through 23.
 * <br>	%I: Two digits hours in 12h format, 00 through 11.
 * <br>	%l (Lower case L): Hours in 12h format, 1 through 11.
 * <br>	%M: Two digits minutes, 00 through 59.
 * <br>	%p: Upper case AM or PM.
 * <br>	%P: Lower case AM or PM.
 * <br>	%S: Two digits seconds, 00 through 59</pre>
 * @param {String} format A string containing some of the formats above.
 * @param {Number} timestamp The JavaScript time to format.
...
SVGElement.prototype = {
	...
	Element.init: function(renderer, nodeName) {
	 ...
	 * @param {Function} complete Function to perform at the end of animation
         * @method
	 */
	Element.animate: function(params, options, complete) {
	 ...
	 *  <pre>
	 *	<br>Most important available attributes:
         *	<br>	d		The path definition for a path element.
         *	<br>	end		The end position of an arc.
         *	<br>	fill		The fill or background color of a shape.
         *	<br>	height		The height of rectangle elements.
         *	<br>	r		The radius of an arc or circle.
         *	<br>	rotation	The rotation of a text element.
         *	<br>	start		The start position of an arc.
         *	<br>	stroke		The stroke or border color of an element.
         *	<br>	stroke-width	The stroke or border width of an element.
         *	<br>	style		A serialized CSS string.
         *	<br>	text		The text string of a text element.
         *	<br>	translateX	The x translation of an element.
         *	<br>	translateY	The Y translation of an element.
         *	<br>	visibility	The visibility of the element. Can be 'visible' or 'hidden'.
         *	<br>	width		The width of rectangle elements.
         *	<br>	x		The x position of supported elements.
         *	<br>	y		The y position of supported elements.
         *	<br>	zIndex		The z index or vertical stacking of an element..
	 * </pre>
	 ...
	 * @param {Mixed|Undefined} val
         * @method
	 */
	Element.attr: function(hash, val) {
		var key, 
			value, 
			i, 
			child,
	 ...
	 * @param {Object} hash
         * @method
	 */
	Element.symbolAttr: function(hash) {
		var wrapper = this;
	 ...
	 * @param {String} id
         * @method
	 */
	Element.clip: function(clipRect) {
	 ...
	 * @param {Number} y
         * @method
	 */
	Element.translate: function(x, y) {
		return this.attr({
			translateX: x,
			translateY: y
		});
	 ...
	 * 
	 */
	Element.align: function(alignOptions, alignByTranslate, box) {
	...
	/**
         * @member Highcharts.Element
	 * Add the element
	 * @param {Object|Undefined} parent Can be an element, an element wrapper or undefined to append the element to the renderer.box.
         * @method
	 */ 
	Element.add: function(parent) {
...
/**
 * @class Highcharts.Renderer
 * General SVG renderer
 */
var Renderer.SVGRenderer = function() {
	this.init.apply(this, arguments);
};


Renderer.SVGRenderer.prototype = {
	/**
	...
	init: function(container, width, height, forExport) {
        ...
        /**
         * @member Highcharts.Renderer
	 * Create a wrapper for an SVG element
	 * @param {Object} nodeName
         * @method
	 */
	Renderer.createElement: function(nodeName) {
	 ...
	 * @param {Object} textNode The parent text SVG node
         * @method
	 */
	Renderer.buildText: function(wrapper) {
	 ...
	 * @param {Number} width
         * @method
	 */
	Renderer.crispLine: function(points, width) {
	 ...
	 * @param {Number} r The radius
         * @method
	 */
	Renderer.circle: function (x, y, r) {
		var attr = isObject(x) ?
			x :
			{
				x: x,
	 ...
	 * @param {Number} end Ending angle
         * @method
	 */
	Renderer.arc: function (x, y, r, innerR, start, end) {
	 ...
	 * @param {Number} strokeWidth A stroke width can be supplied to allow crisp drawing
         * @method
	 */
	Renderer.rect: function (x, y, width, height, r, strokeWidth) {
	 ...
	 * @param {Boolean} animate
         * @method
	 */
	Renderer.setSize: function(width, height, animate) {
		var renderer = this,
         ...
         * @member Highcharts.Renderer
	 * Create a group
	 * @param {String} name The group will be given a class name of 'highcharts-{name}'. This can be used for styling and scripting.
         * @method
	 */
	Renderer.g: function(name) {
	 ...
	 * @param {Number} height
         * @method
	 */
	Renderer.image: function(src, x, y, width, height) {
		var attribs = {
	 ...
	 * @param {Object} options
         * @method
	 */
	Renderer.symbol: function(symbol, x, y, radius, options) {
	 ...
	 * @param {Number} height
         * @method
	 */
	Renderer.clipRect: function (x, y, width, height) {
		var wrapper,
			id = PREFIX + idCounter++,
	 ...
	 * @param {Object} color The color or config object
         * @method
	 */
	Renderer.color: function(color, elem, prop) {
		var colorObject,
			regexRgba = /^rgba/;
	 ...
	 * @param {Number} y Top position
         * @method
	 */
	Renderer.text: function(str, x, y) {
...
/**
 * @class Highcharts.Chart  The chart class
 */
Chart = new function (){
	// javadoc utility to show singleton classes.
};

//this Chart class is being used only for documentation purposes
Charts = function (options, callback) {
	...
	Chart.Tooltip = function (options) {
		 ...
		 * In case no user defined formatter is given, this will be used
		 */
		Chart.defaultFormatter = function () {
			var pThis = this,
				items = pThis.points || splat(pThis),
				xAxis = items[0].series.xAxis,				
				x = pThis.x,
		 ...
		 * @param {Number} finalY 
		 */
		Chart.move = function (finalX, finalY) {
	 ...
	 * @param {Object} options
         * @method
	 */
	Chart.MouseTracker = function (chart, options) {
 ...
 * @ignore
	 ...
	 * Initialize an individual series, called internally before render time
         * @method
	 */
	Chart.initSeries = function (options) {
		var type = options.type || optionsChart.type || optionsChart.defaultSeriesType,
			typeClass = seriesTypes[type],
			serie,
			hasRendered = chart.hasRendered;
	 ...
	 * @return {Object} series The newly created series object
         * @method
	 */
	Chart.addSeries = function (options, redraw, animation) {
		var series;
	 ...
	 * @param {Number} y Pixel y relative to the coordinateSystem
         * @method
	 */
	Chart.isInsidePlot = function(x, y) {
		return x >= 0 &&
			x <= plotWidth &&
			y >= 0 &&
			y <= plotHeight;
	 ...
	 * @param {Boolean|Object} animation Whether to apply animation, and optionally animation configuration
         * @method
	 */
	Chart.redraw = function (animation) {
		var redrawLegend = chart.isDirtyLegend,
			hasStackedSeries,
			isDirtyBox = chart.isDirtyBox, // todo: check if it has actually changed?
			seriesLength = series.length,
	 ...
	 * @param {String} str An optional text to show in the loading label instead of the default one
         * @method
	 */
	Chart.showLoading = function (str) {
		var loadingOptions = options.loading;
	 ...
	 * Get the currently selected series
         * @method
	 */
	Chart.getSelectedSeries = function () {
		return grep(series, function (serie) {
			return serie.selected;
		});
	}
	 ...
	 * @param subtitleOptions {Object} New subtitle options
         * @method
	 */
	Chart.setTitle = function  (titleOptions, subtitleOptions) {
	...
	Chart.Axis = function (chart, options) {
		...
		/*
		 * The object wrapper for plot lines and plot bands (ignored 2)
		 * @param {Object} options
		 */
		function PlotLineOrBand(options) {
			var plotLine = this;
...
/**
 * @class Highcharts.Point The Point object and prototype. Inheritable and used as base for PiePoint.
 */
var Point = function() {};
...
/**
 * @class Highcharts.Series The base function which all other series types inherit from
 */
var Series = function() {};
...
Series.prototype = {
	...
	isCartesian: true,
	/**
         * @property type The series' type, like "line", "area" etc.
         * @type string
         */
	type: 'line',
	
	/**
         * @property chart The chart that the series belongs to.
         * @type Object
         */
	 
	/**
         * @property name The series' name as given in the options.
         * @type String
         */
	
        /**
         * @property options The series' options.
         * @type Object
         */	 
	
        /**
         * @property selected The series' selected state as set by series.select().
         * @type Boolean
         */
         	
	/**
         * @property visible The series' visibility state as set by series.show(), series.hide(), or the initial configuration.
         * @type Boolean
         */	
	
        /**
         * @property xAxis The unique xAxis object associated with the series.
         * @type Object
         */	

	/**
         * @property yAxis The unique yAxis object associated with the series.
         * @type Object
         */	
	 ...
	 * @param {Boolean} redraw Whether to redraw the chart or wait for an explicit call
	 * @param {Boolean} shift If shift is true, a point is shifted off the start of the series as one is appended to the end.
	 * @param {Boolean|Object} animation Whether to apply animation, and optionally animation configuration
	 */
...
/**
 * @class Highcharts.Series.LineSeries
...
/**
 * @class Highcharts.Series.AreaSeries
 * @extends Highcharts.Series
 * The Area series class
 */
...
/**
 * @class Highcharts.Series.SplineSeries
 * @extends Highcharts.Series
 * The Spline series class
 */
...
/**
 * @class Highcharts.Series.AreaSplineSeries
 * @extends Highcharts.SplineSeries
 * The Area Spline series class
 */
...
/**
 * @class Highcharts.Series.ColumnSeries
 * @extends Highcharts.Series
...
/**
 * @class Highcharts.Series.BarSeries
 * @extends Highcharts.ColumnSeries
...
/**
 * @class Highcharts.Series.ScatterSeries
 * @extends Highcharts.Series
...
/**
 * @class Highcharts.Point.PiePoint Extended point object for pies
...
/**
 * @class Highcharts.Series.PieSeries
 * @extends Highcharts.Series
