...
Unity.Notification.NotificationData = {
	...
	/**
     * The name of a sound file in the application bundle, that would be played as an alert. If the sound file doesn not exist or default is specified as the value, the default alert sound is played. 
     * @type {String}
     */
	Sound : 'default',
