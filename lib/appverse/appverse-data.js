 ...
 */
 ...
 /**
 * @class Appverse.Net.SecondaryBrowserOptions
 * @namespace Appverse.Net
 * @extends Object
 * This is a sample class.<br/><br/>
 * Used only for Documentation purposes (the class does not really exist in this package, do not try to instantiate it).<br/><br/>
 * Data related to options for auxiliary browser used in OpenBrowserWithOptions and ShowHtmlWithOptions methods.
 * @author ddbc
 * @version 4.6
 */
 Appverse.Net.SecondaryBrowserOptions = {
 	/**
     * Title given to the auxiliary browser.
	 * @type {String}
     */ 
	Title: 'My Title',
	
	/**
     * URL to load in the auxiliary browser.
	 * @type {String}
     */ 
	Url: 'http://www.google.com',
	
	/**
     * Caption that should display the Close Button of the auxiliary browser.
	 * @type {String}
     */ 
	CloseButtonText:'Close',
	
	/**
     * Html code to display in the auxiliary browser.
	 * @type {String}
     */ 
	Html:'<html><body>Hello World</body></html>',
	
	/**
     * Array of string containing the file extensions the OS will handle when such files are requested in the URL. Ex: ".pdf", ".xsl"
	 * @type {String []}
     */ 
	BrowserFileExtensions: ['.pdf','.xls']
...
Appverse.Pim.Contact = {
	...
	/**
     * The company for the current contact.
	 * @type {String}
     */ 
	Company: '',
...
Appverse.Pim.ContactQuery = {
	 ...
	 * {@link Appverse.Pim#CONTACTS_QUERY_CONDITION_AVAILABLE}
	 * @type {int}
     */
	Condition: 0,
	 ...
	 * {@link Appverse.Pim#CONTACTS_QUERY_COLUMN_PHONE}
	 * @type {int}
     */
	Column: 0,
...
/**
 * @class Appverse.Beacon.Beacon
 * @namespace Appverse.Beacon
 * @extends Object
 * This is a sample class.<br/><br/>
 * Used only for Documentation purposes (the class does not really exist in this package, do not try to instantiate it).<br/><br/>
 * Represents the Beacon<br><br> See more information at <b>Appverse.Beacon</b>.
 ...
 * @version 4.7
 */
Appverse.Beacon.Beacon = {
	
    /**
     * The Address asociated
     * @type {String}
     */
    address: '',
            
    /**
     * The name of the beacon device
     * @type {String}
     */
    name: '',
    ...
    UUID: '',
     ...
     /** 
     * Tne Distance name to the beacon 
	 * <br/>Possible values: 
	 * {@link Appverse.Beacon#IMMEDIATE},
	 * {@link Appverse.Beacon#NEAR}, 
	 * {@link Appverse.Beacon#FAR}, 
	 * {@link Appverse.Beacon#UNKNOWN}, 
     * @type {int}
     */
    distance: 0,
    ...
    /**
     * The major version of the device
     * @type {int}
     */
    major: 0,
    /**
     * The minor version of the device
     * @type {int}
     */
    minor: 0,
            
    /**
     * Time when scan was done
     * @type {long}
     */
    timestamp: ''
};
